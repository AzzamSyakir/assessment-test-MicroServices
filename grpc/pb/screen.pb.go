...
func file_screen_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_screen_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_screen_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_screen_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_screen_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
